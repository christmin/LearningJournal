...
<ol>
  ...
  - simple component for displaying a button and detecting a press. It comes with its own styling. It does not accept the style prop, so if we require more customisation we should use the Touchable opacity instead.
...
<ol>
  <li>Create a separate folder in source</li>
