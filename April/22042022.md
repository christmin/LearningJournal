...
It is day 8 of learning React Native on Udemy. Today's learning topic is RN state managment - importance of handling error bounds and usability of switch case to optimize function. I want to go to the Ramadan bazaar to eat later lol.

## Action Items

[] Add bounds check to ensure the color values are between 0 to 255

[] Refactor the codes by creating a setColor function and pass in the color and value to update the states of the colors

[] Ensure that once value is 255/0, there will be no changes even when buttons are pressed.
